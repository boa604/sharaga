...
pkgdatadir = $(datadir)/products
pkgincludedir = $(includedir)/products
pkglibdir = $(libdir)/products
pkglibexecdir = $(libexecdir)/products
...
OBJEXT = o
PACKAGE = products
PACKAGE_BUGREPORT = fukilya@gmail.com
PACKAGE_NAME = products
PACKAGE_STRING = products 0.01
PACKAGE_TARNAME = products
PACKAGE_URL = 
